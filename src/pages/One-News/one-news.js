  ...
  return (
    <div className="this-page-one-news-container">
      ...
      <div className="this-page-one-news-container-content">
        ...
        <div><i>Fonte: Site - Jornal Contábil<br/><a href="https://www.jornalcontabil.com.br/como-manter-a-seguranca-durante-a-volta-dos-colaboradores-ao-ambiente-de-trabalho/" target="_blank">https://www.jornalcontabil.com.br/como-manter-a-seguranca-durante-a-volta-dos-colaboradores-ao-ambiente-de-trabalho/</a></i></div>
      </div>
      <RequestContact/>
      <Footer/>
    </div>
